...
int epochFromTime(TIME time){
	...
	switch(month-1){
		...
		day =day-1;//Minus one day because the day would not have been complete by then
		year =year-22;//Minus 22 because we have been given the epoch time from start of 22.
